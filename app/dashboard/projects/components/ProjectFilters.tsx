...
import type { AdminProjectFilters } from "../types";

interface ProjectFiltersProps {
  filters: AdminProjectFilters;
  onFiltersChange: (filters: AdminProjectFilters) => void;
  onClearFilters: () => void;
}

export default function ProjectFilters({ filters, onFiltersChange, onClearFilters }: ProjectFiltersProps) {
