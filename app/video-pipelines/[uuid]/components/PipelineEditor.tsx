...
export default function PipelineEditor() {
  ...
  }, [canUndo, canRedo, undo, redo, forceRelayout]);
    ...
    <div className="flex-1 flex overflow-hidden relative">
      ...
      <div className="absolute bottom-4 left-4 z-40 bg-black bg-opacity-70 text-white text-xs p-3 rounded-lg max-w-xs">
        ...
        <div className="space-y-1">
          ...
          <div><kbd className="bg-gray-700 px-1 rounded">⌘/Ctrl ⇧ Z</kbd> Redo</div>
          <div><kbd className="bg-gray-700 px-1 rounded">R</kbd> Auto-layout</div>
